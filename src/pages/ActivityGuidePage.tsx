...
import { getSuggestedActivities } from '../services/openaiService';
...
const ActivityGuidePage: React.FC = () => {
  ...
  useEffect(() => {
    const fetchActivities = async () => {
      ...
      const suggestedActivities = await getSuggestedActivities(selectedLocation, [theme]);
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-3xl font-bold mb-6 text-center">Activities in {location.state.location}</h1>
